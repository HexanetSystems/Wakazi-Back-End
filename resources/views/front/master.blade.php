                    ...
                    <div class="row align-items-center">
                                ...
                                <li>
                                    <div class="dropdown language-switcher d-inline-block">
                                        <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img src="{{asset('theme/assets/img/us-flag.jpg')}}" alt="image">
                                            <span>Eng <i class="bx bx-chevron-down"></i></span>
                                        </button>

                                        <div class="dropdown-menu">
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="{{asset('theme/assets/img/germany-flag.jpg')}}" class="shadow-sm" alt="flag">
                                                <span>Ger</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="{{asset('theme/assets/img/france-flag.jpg')}}" class="shadow-sm" alt="flag">
                                                <span>Fre</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="{{asset('theme/assets/img/spain-flag.jpg')}}" class="shadow-sm" alt="flag">
                                                <span>Spa</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="{{asset('theme/assets/img/russia-flag.jpg')}}" class="shadow-sm" alt="flag">
                                                <span>Rus</span>
                                            </a>
                                            <a href="#" class="dropdown-item d-flex align-items-center">
                                                <img src="{{asset('theme/assets/img/italy-flag.jpg')}}" class="shadow-sm" alt="flag">
                                                <span>Ita</span>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="top-header-discount-info">
                                <p><strong>10% OFF</strong> on your first order <a href="#">Learn More</a></p>
                            </div>
                        </div>
                            ...
                            <div class="collapse navbar-collapse mean-menu">
                                ...
                                <div class="others-option">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="option-item">
                                            <div class="cart-btn">
                                                <a href="#" data-bs-toggle="modal" data-target="#shoppingCartModal"><i class='bx bx-shopping-bag'></i><span>0</span></a>
                                            </div>
                                        </div>

                                        <div class="option-item">
                                            <a href="#" class="default-btn"><i class="bx bx-plus"></i> Add Listing</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="products-cart-content">
                            <div class="products-cart">
                                <div class="products-image">
                                    <a href="#"><img src="{{asset('theme/assets/img/products/img1.jpg')}}" alt="image"></a>
                                </div>
                            ...
                            <div class="products-cart">
                                <div class="products-image">
                                    <a href="#"><img src="{{asset('theme/assets/img/products/img2.jpg')}}" alt="image"></a>
                                </div>
                            ...
                            <div class="products-cart">
                                <div class="products-image">
                                    <a href="#"><img src="{{asset('theme/assets/img/products/img3.jpg')}}" alt="image"></a>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget pl-4">
                            ...
                            <ul class="quick-links">
                                ...
                                <li><a href="listing-1.html">Listing</a></li>
